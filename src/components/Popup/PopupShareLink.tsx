...
const PopupShareLink: React.FC<IPopupShareLink> = ({username}) => {
  const dispatch = useAppDispatch();

  return (
    <div className={` modal-backdrop flex flex-col gap-3`}>
      <div>
      ...
      <div
        ...
        <div className={'flex flex-col gap-2'}>
          <button
            onClick={() => {
              navigator.clipboard.writeText(`https://twillink.com/${username}`);
