...
import ConsultationForm from './modal/consult';
import Webinar from './modal/webinar';
import Meets from './modal/meet';

const PopupSchedule = ({isOpen, onClose}) => {
  ...
  return (
    <div className="fixed inset-0 bg-gray-800 bg-opacity-50 flex justify-center items-center z-[99999]">
      ...
      <Meets isOpen={isModalOpen3} onClose={() => setIsModalOpen3(false)} />
      <div className="bg-white rounded-3xl shadow-lg max-w-3xl w-full p-6">
        {/* Header */}
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-lg font-semibold text-gray-800">Add Schedule</h2>
          <button
            onClick={onClose}
            className="absolute  bg-gray-300 w-8 h-8 rounded-full ml-[39%]">
            X
          </button>
        </div>
